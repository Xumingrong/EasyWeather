...
import com.easy.weather.WeatherApplication;
import com.easy.weather.api.entity.DailyForecast;
...
import com.easy.weather.utils.WeatherPreferenceUtil;
...
import com.easy.weather.weather.BaseDrawer.Type;
...
//	}
    ...
    public static ArrayList<Area> loadSelectedArea(Context context) {
        ...
        String json = WeatherApplication.USE_SAMPLE_DATA ? GITHUB_SAMPLE_SELECTED_AREA : WeatherPreferenceUtil.getPrefString(context, KEY_SELECTED_AREA, "");
...
//	}
     ...
     *
     * @param context //	 * @param loadAreaDataListener
     */
