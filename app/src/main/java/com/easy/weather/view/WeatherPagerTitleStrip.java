...
public class WeatherPagerTitleStrip extends ViewGroup implements WeatherViewPager.Decor {
	private static final String TAG = "PagerTitleStrip";

	WeatherViewPager mPager;
	TextView mPrevText;
	TextView mCurrText;
	TextView mNextText;
	...
	public WeatherPagerTitleStrip(Context context) {
		this(context, null);
	}

	public WeatherPagerTitleStrip(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private class CircleIndicator extends View implements WeatherViewPager.OnPageChangeListener{
...
//			Log.e("CircleIndicator", "onPageScrollStateChanged()->" + state );
			switch (state) {
			case WeatherViewPager.SCROLL_STATE_IDLE:
				hideSelf();
				break;
			default:
				showSelf();
...
//			canvas.restoreToCount(sc);
	...
	protected void onAttachedToWindow() {
		...
		if (!(parent instanceof WeatherViewPager)) {
			throw new IllegalStateException("PagerTitleStrip must be a direct child of a ViewPager.");
		}

		final WeatherViewPager pager = (WeatherViewPager) parent;
...
//		final int contentWidth = prevWidth + currWidth + nextWidth;// stripWidth
	...
	private class PageListener extends DataSetObserver implements WeatherViewPager.OnPageChangeListener,
			WeatherViewPager.OnAdapterChangeListener {
		...
		@Override
		public void onPageSelected(int position) {
			if (mScrollState == WeatherViewPager.SCROLL_STATE_IDLE) {
